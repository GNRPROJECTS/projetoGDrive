...
public class DriveQuickstart {
    ...
    /**Scopo de instâncias globais requeridas.
     * Se modificado o scopo, deletar as credenciais previamente salvas
     * em ~/.credentials/drive-java-quickstart
     */
    ...
    public static Credential authorize() throws IOException {
        ...
        Credential credential = new AuthorizationCodeInstalledApp(
            flow, new LocalServerReceiver()).authorize("snakegnr77");
        System.out.println(
